        ...
        try:
            ...
            if not file_path:
                return build_mcp_tool_error_response({
                    "error_message": f"Output ID not found: {input_data.output_id}"
                })
            ...
            if not path.exists():
                return build_mcp_tool_error_response({
                    "error_message": f"Output file not found: {file_path}"
                })
            ...
            try:
                ...
                return build_mcp_tool_error_response({
                    "error_message": f"Failed to decode file as UTF-8: {file_path}"
                })
