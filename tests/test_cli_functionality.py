...
class TestCLIActions:
    ...
    def test_remote_action(self, mock_cleanup, mock_create_temp, mock_git_installed, mock_clone, mock_run_default):
        """Test remote action"""
...
class TestCLIIntegration:
    ...
    def test_cli_error_handling_integration(self):
        ...
        with patch('src.repomix.cli.cli_run.execute_action', side_effect=Exception("Integration error")):
