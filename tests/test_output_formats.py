...
class TestOutputGeneration:
    ...
    def setup_method(self):
        ...
        self.processed_files = [
            ProcessedFile(path="src/main.py", content="def main():\n    print('Hello, World!')\n    return 0"),
...
Run with: `python app.py`
            ...
            styles = [RepomixOutputStyle.PLAIN, RepomixOutputStyle.MARKDOWN, RepomixOutputStyle.XML]
    ...
    def test_output_with_different_file_types(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            processed_files = [
                ProcessedFile(path=f.name, content=f.read_text()) for f in files
            ]
