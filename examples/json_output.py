...
def main():
    ...
    with open(result.config.output.file_path, "r", encoding="utf-8") as f:
        data = json.load(f)

    # Display structure of the JSON output
    print("\nJSON Output Structure:")
    print(f"- summary: Contains metadata and statistics")
    print(f"- file_tree: Directory structure as nested object")
